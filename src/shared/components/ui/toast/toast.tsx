...
export function Toast({ state = 'initial', message, onReset, onSave, onDismiss }: ToastProps) {
    const commonClasses =
                ...
                <AnimatePresence>
                    {state === 'initial' && (
                        ...
                        >
                            ...
                            >
                                <div className="text-white text-[13px] font-normal font-['Geist'] leading-tight">
                                    Reset
                                </div>
                            </button>
                            <div
