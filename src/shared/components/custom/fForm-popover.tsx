...
function PopoverFormSuccess({
	...
	return (
		<>
			...
			>
				<title id="successIcon">Success Icon</title>
				<path
...
function PopoverFormSeparator({
	...
	return (
		<svg
			...
			fill="none"
			xmlns="http://www.w3.org/2000/svg"
			aria-labelledby="separatorLine"
		>
			<title id="separatorLine">Separator Line</title>
...
function PopoverFormCutOutTopIcon({
	...
	return (
		<svg
			...
			aria-labelledby="cutOutTop"
		>
			<title id="cutOutTop">Cut Out Top Icon</title>
...
function PopoverFormCutOutLeftIcon() {
	return (
		<svg
			...
			fill="none"
			xmlns="http://www.w3.org/2000/svg"
			aria-labelledby="cutOutLeft"
		>
			<title id="cutOutLeft">Cut Out Left Icon</title>
			<g clipPath="url(#clip0_2029_22)">
				<path
					d="M0 2C0.656613 2 1.30679 2.10346 1.91341 2.30448C2.52005 2.5055 3.07124 2.80014 3.53554 3.17157C3.99982 3.54301 4.36812 3.98396 4.6194 4.46927C4.87067 4.95457 5 5.47471 5 6C5 6.52529 4.87067 7.04543 4.6194 7.53073C4.36812 8.01604 3.99982 8.45699 3.53554 8.82843C3.07124 9.19986 2.52005 9.4945 1.91341 9.69552C1.30679 9.89654 0.656613 10 0 10V6V2Z"
					className="fill-muted"
...
function PopoverFormCutOutRightIcon() {
	return (
		<svg
			...
			fill="none"
			xmlns="http://www.w3.org/2000/svg"
			aria-labelledby="cutOutRight"
		>
			<title id="cutOutRight">Cut Out Right Icon</title>
			<g clipPath="url(#clip0_2029_22)">
				<path
					d="M0 2C0.656613 2 1.30679 2.10346 1.91341 2.30448C2.52005 2.5055 3.07124 2.80014 3.53554 3.17157C3.99982 3.54301 4.36812 3.98396 4.6194 4.46927C4.87067 4.95457 5 5.47471 5 6C5 6.52529 4.87067 7.04543 4.6194 7.53073C4.36812 8.01604 3.99982 8.45699 3.53554 8.82843C3.07124 9.19986 2.52005 9.4945 1.91341 9.69552C1.30679 9.89654 0.656613 10 0 10V6V2Z"
					className="fill-muted"
