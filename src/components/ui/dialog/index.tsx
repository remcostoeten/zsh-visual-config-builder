...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Title ref={ref} className='text-lg font-semibold text-white' {...props} />
))
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Description ref={ref} className='text-sm text-gray-400' {...props} />
))
